...
$APPLICATION->SetTitle("jobboard2");
?>
<!-- slider_area_start -->
<div class="slider_area">
        ...
        <div class="ilstration_img wow fadeInRight d-none d-lg-block text-right" data-wow-duration="1s" data-wow-delay=".2s">
            <img src="<?=SITE_TEMPLATE_PATH?>/img/banner/illustration.png" alt="">
        </div>
    </div>
    <!-- slider_area_end -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/img/svg_icon/2.svg" alt="">
                                </div>
                                <div class="jobs_conetent">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/img/svg_icon/3.svg" alt="">
                                </div>
                                <div class="jobs_conetent">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/img/svg_icon/4.svg" alt="">
                                </div>
                                <div class="jobs_conetent">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/img/svg_icon/5.svg" alt="">
                                </div>
                                <div class="jobs_conetent">
                                    <a href="job_details.html"><h4>Software Engineer</h4></a>
                                    <div class="links_locat d-flex align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="candidate_active owl-carousel">
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/1.png" alt="">
                            </div>
                        ...
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/2.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/3.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/4.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/5.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/6.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/7.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/8.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/9.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                        ...
                        <div class="single_candidates text-center">
                            <div class="thumb">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/candiateds/10.png" alt="">
                            </div>
                            <a href="#"><h4>Markary Jondon</h4></a>
                            <p>Software Engineer</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="single_testmonial d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/img/testmonial/author.png" alt="">
